...
public interface InitValues {
    ...
    public static final int BALL_INITIAL_POS_X = 0;
    public static final int BALL_INITIAL_POS_Y = 0;
    
    public static final int BALL_RADIUS = 5;
    
    public static final int PADDLE_PLAYER_WIDTH = 0;
    public static final int PADDLE_PLAYER_HEIGHT = 0;
    public static final int PADDLE_PLAYER_INITIAL_POS_X = 0;
    public static final int PADDLE_PLAYER_INITIAL_PoS_Y = 0;
    ...
    public static final int REDLINE_POS_Y = 0;
